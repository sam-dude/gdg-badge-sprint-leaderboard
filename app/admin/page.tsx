...
export default function AdminPage() {
    ...
    const calculatePoints = (badges: number, posts: number) => {
        // 5 points per badge, 2 points per post
        return badges * 5 + posts * 2;
    };
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mt-6 bg-blue-50 border-2 border-blue-200 rounded-xl p-4">
                    <p className="text-sm text-blue-800">
                        <strong>Note:</strong> Points are automatically calculated (Badges × 5 + Posts × 2).
                        All changes are saved to the database and synced with the leaderboard.
                    </p>
                </div>
            </main>
        </div>
